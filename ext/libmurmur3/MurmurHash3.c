...
FORCE_INLINE void bmix32(uint32_t * h1, uint32_t * k1, uint32_t * c1, uint32_t * c2 )
{
  *c1 = *c1*5+0x7b7d159c;
  *c2 = *c2*5+0x6bce6396;
...
FORCE_INLINE void bmix32_2 ( uint32_t * h1, uint32_t * h2,
                           ...
                           uint32_t seed, void * out )
{
  ...
  for(i = 0; i < nblocks; i++)
  {
    ...
    bmix32_2(&h1,&h2,&h3,&h4, &k1,&k2,&k3,&k4, &c1,&c2);
  }
